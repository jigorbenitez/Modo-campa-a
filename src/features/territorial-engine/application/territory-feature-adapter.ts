...
import { categorySearchTerms } from "@/features/territorial-quality";

const layerByCategory: Record<string, TerritoryFeature["layerId"]> = {
  education_school: "schools",
  education_primary: "schools",
  education_secondary: "schools",
  education_technical: "schools",
  education_kindergarten: "schools",
  education_university: "schools",
  health_hospital: "hospitals",
  health_caps: "health_centers",
  health_clinic: "health_centers",
  security_police: "police",
  security_fire_station: "firefighters",
  sport_club: "clubs",
  sport_sports_center: "clubs",
  sport_municipal_field: "clubs",
  public_square: "green_spaces",
  public_park: "green_spaces",
  public_waterfront: "green_spaces",
  school: "schools",
...
const subtypeByCategory: Record<string, string> = {
  ...
  education_technical: "Técnica",
  education_kindergarten: "Jardín",
  education_university: "Universidad",
  health_hospital: "Hospital",
  health_caps: "CAPS",
  health_clinic: "Sala",
  security_police: "Comisaría",
  security_fire_station: "Bomberos",
  security_civil_defense: "Defensa Civil",
  sport_club: "Club",
  sport_sports_center: "Polideportivo",
  sport_municipal_field: "Cancha municipal",
  public_square: "Plaza",
  public_park: "Parque",
  public_waterfront: "Costanera",
  municipality_delegation: "Delegación",
  municipality_secretariat: "Secretaría",
  transport_station: "Estación",
...
export function territorialEntityToMapFeature(
  ...
  return {
    ...
    title: entity.name,
    description: [entity.description, ...(entity.alternateNames ?? []), categorySearchTerms(entity.category)].filter(Boolean).join(" · "),
    point,
