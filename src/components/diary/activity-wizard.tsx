...
const barrios = [
  { id: "barrio-centro", name: "Centro" },
  { id: "barrio-estacion", name: "Estación" },
];
        ...
        <header className="border-b border-[var(--border)] bg-[var(--surface)] px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h2 id="wizard-title" className="mt-1 text-lg font-extrabold">Nueva actividad · {steps[step]}</h2>
            </div>
        ...
        <div className="overflow-y-auto px-4 py-5 sm:px-6 sm:py-6">
          ...
          {step === 5 && (
            <div className="space-y-5">
              ...
              <p className="text-xs leading-5 text-[var(--muted)]">En esta etapa los datos se guardan sólo durante la sesión y se incorporan inmediatamente al Diario.</p>
            </div>
          )}
        </div>
